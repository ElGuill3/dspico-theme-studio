...
// prettier-ignore
export type BcstmReceiptV13 = { version: 1; schema: typeof BCSTM_RECEIPT_SCHEMA_V13; component: "bcstm"; tester: string; device: string; cartridge: string; launcherBuild: string; testedAt: string; profile: { id: string; commit: string; sha256: string }; sourceSha256: string; path: string; observations: readonly string[]; pass: true };
// prettier-ignore
