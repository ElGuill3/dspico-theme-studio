...
(Previously: The preview centered generated mode scenes and scoped token overrides as the editable Material model.)
...
(Previously: Material colors and scene rendering could be labeled as evidence-backed without restricting them to launcher-consumed fields.)

#### Scenario: Show source-backed fidelity

- GIVEN a rendered property has an accepted v1.3.0 vector and fixture
